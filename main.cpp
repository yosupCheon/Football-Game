...
/*
What to do Next
- make a function that turn to default formation (4-3-3)
- depends on the tactic, move players
- organize codes
*/
...
int main () {
    ...
    Player t2CB4 ("t2CB4", "CB", 32, 20, 65, 20);
    // MIDFIELDER
    ...
    Player t2ST2 ("t2ST2", "ST", 35, 58, 15, 10);
    Player t2ST3 ("t2ST3", "ST", 30, 80, 10, 20);
